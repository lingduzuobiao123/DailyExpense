...
public class LogUtils {
	...
	private static String MYLOGFILEName = "daily_expense_Log.txt";// 本类输出的日志文件名称
	private static SimpleDateFormat myLogSdf = new SimpleDateFormat(
			"yyyy-MM-dd HH:mm:ss");// 日志的输出格式
	private static SimpleDateFormat logfile = new SimpleDateFormat("yyyy-MM-dd");// 日志文件格式
	public static final String LOG_FILE_PATH = "/DailyExpense/log/";
	...
	private static void writeLogtoFile(Context context, String mylogtype,
		...
		String needWriteMessage = myLogSdf.format(nowtime) + "    =="
				+ System.currentTimeMillis() + "==    " + tag + "    " + text;
